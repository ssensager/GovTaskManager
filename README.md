# ГосЗадачи — Корпоративная система управления задачами

Полнофункциональное веб-приложение для управления задачами и контроля исполнения поручений в государственных и корпоративных организациях.
